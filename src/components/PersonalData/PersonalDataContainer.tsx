...
import { type EducationHistoryType, type LanguageHistoryType, type LanguageInfoType, type SkillsHistoryType, type User, type UserEducationHistory, type UserSkillType, type UserWorkHistory, type WorkHistoryType } from '../../types/types'
